...
El tipo `numérico` es lo que hemos hecho hasta ahora, almacenando números. Hay dos tipos principales de números con R: enteros (*integer*) y números decimales (*double*). Por defecto, R considera todos los números como números decimales y asigna el tipo `double`.
